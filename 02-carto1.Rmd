...
?cartography
```
* La [vignette](https://CRAN.R-project.org/package=cartography/vignettes/cartography.html) associée au package présente des exemples de scripts 
```{r, eval = FALSE}
vignette("cartography")
```
* Le blog [R Géomatique](https://rgeomatic.hypotheses.org/), maintenu par l'auteur de *cartography* qui met à disposition ressources et exemples liés au package et plus généralement à l'écosystème spatiale de R.  

* La [cheat sheet](http://riatelab.github.io/cartography/vignettes/cheatsheet/cartography_cheatsheet.pdf) de cartography, qui résume les principales fonctions du package de façon synthétique.   
