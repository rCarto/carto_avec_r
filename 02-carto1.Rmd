...
resto <- rbind(res.sf.pts[, c("osm_id", "name")], 
               res.sf.pol[, c("osm_id", "name")], 
               ff.sf.pts[, c("osm_id", "name")], 
               ff.sf.pol[, c("osm_id", "name")], 
               caf.sf.pts[, c("osm_id", "name")], 
               caf.sf.pol[, c("osm_id", "name")])
