...
library(sf)
library(osmdata)
mtq <- st_read(dsn = "data/mtq.gpkg", quiet = TRUE)
...
mtq <- st_read("data/mtq.gpkg", quiet = TRUE)
...
[Exercices de traitement de données spatiales](https://rcarto.github.io/carto_avec_r_exo/#1_traitement_de_donn%C3%A9es_spatiales)
