...
### Export
```{r export}
st_write(obj = mtq_v, dsn = "data/mtq.gpkg", layer = "voronoi", delete_layer = TRUE)
st_write(obj = mtq_c, "data/mtq_centroid.shp", delete_layer = T)
```
